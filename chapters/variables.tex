...
\begin{lstlisting}
// Input a squared number and an initial guess for its square root
// The squared number will not change. Use a constant to represent it.
const square = 2;
// The current guess will get updated over time. Use a variable to represent it.
let guess = 1;

// Step 1a. Check whether the current guess approximates the square root well enough.
// The check will change as we update the current guess. Use a variale to reprsent it.
let check = guess - square / guess;

// Step 2. Update the current guess with the average of guess and square / guess.
...
// Step 1a. Check.
check = guess - square / guess;
// Step 1b. Return the approximate square root.
// This value will not change. Use a constant to represent it.
const sqrt = guess;
\end{lstlisting}
