...
\begin{lstlisting}[caption={Calculating $\sqrt{2}$ to three decimal places using Newton's Method}]
> // Initial guess: 1
> 1
1
> // Step 1a. Check if the current guess is close enough.
> 1 - 2/1
0.5
> // 0.5 is not close enough. Keep going.
> // Step 2. Update the current guess.
> (1 + 2/1)/2
1.5
...
> // Step 1a. Check if the current guess is close enough.
0.16666666666666674
> // 0.1666666674 is not close enough. Keep going.
> // Step 2. Update the current guess.
> (1.5 + 2/1.5)/2
1.4166666666666665
> // The new guess is 1.4166666666666665.
> // Step 1a. Check if the current guess is close enough.
> 1.4166666666666665 - 2/1.4166666666666665
0.004901960784313486
> // 0.004901960784313486 is 2 decimal places correct. But we want three. Keep going.
> // Step 2. Update the current guess.
> (1.4166666666666665 + 2/1.4166666666666665)/2
> // The new guess is 1.4142156862745097
> // Step 3, go back to Step 1.
> // Step 1a. Check if the current guess is close enough.
> 1.4142156862745097 - 2/1.4142156862745097
> 0.0000042477996395895445
> // Step 3, go to Step 1 again.
> // Check: 0.0000042477996395895445 tells us we are correct to 5 decimal places. Stop! Our current guess is good enough. Return the current guess 1.4142156862745097. That value is our output.
