...
\begin{table*}
  ...
  \begin{tabular}{l c l c c c c}
    Step & Squared Number & Current Guess & Updated Guess Expression & Updated Guess Evaluation & Check Expression & Check Evaluation\\
    Inputs & \textbf{\texttt{2}} & \textbf{\texttt{1}} & --- & --- & --- \\
    Step 1a & \texttt{2} & \texttt{1} & --- & --- & \texttt{1 - 2/1} & \texttt{0.5}\\
    Step 2 (Evaluate) & \texttt{2} & \texttt{1} & \texttt{(1 + 2/1)/2} & \texttt{1.5} & --- & ---\\
    Step 2 (Assign) & \texttt{2} & \texttt{1.5} & \texttt{(1 + 2/1)/2} & \texttt{1.5} & --- & ---\\
    Step 3 & \texttt{2} & \texttt{1.5} & --- & --- & --- & ---\\
    Step 1a & \texttt{2} & \texttt{1.5} & --- & --- & 1.5 - 2/1.5 & 0.16666\\
    Step 2 (Evaluate) & \texttt{2} & \texttt{1.5} & (1.5 + 2/1.5)/2 & 1.41666\dots & ---& 0.1666\dots\\
    Step 2 (Assign) & \texttt{2} & \texttt{1.41666} & --- & --- & --- & ---\\
    Step 3 & \texttt{2} & \texttt{1.41666} & --- & --- & --- & ---\\
    Step 1a & \texttt{2} & \texttt{1.41666} & --- & --- & 1.41666 - 2/1.41666 & 0.0049\\
    Step 2 (Evaluate) & \texttt{2} & \texttt{1.41666} & (1.4166 + 2/1.4166)/2 & 1.414215\\
    Step 2 (Assign) & \texttt{2} & \texttt{1.41421} & --- & --- & --- & ---\\
    Step 3 & \texttt{2} & \texttt{1.41421} & --- & --- & --- & ---\\
    Step 1a &  \texttt{2} & \texttt{1.41421} & --- & --- & 1.41421 - 2/1.41421 & 0.000004\\
    Step 1b & \texttt{2} & \textbf{\texttt{1.41421}} & --- & --- & --- & ---\\
  \end{tabular}
  \caption{Trace of the execution of Newton's method in Listing \ref{listing:intro-newton}. Numeric values have been truncated to 5 decimal places for readability. The program used the full values.}
\end{table*}
