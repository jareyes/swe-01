...
1. If guess and n / guess are sufficiently close to each other
   Return the current value of guess
2. Otherwise update guess with the average of guess and n / guess.
3. Go to Step 1
\end{lstlisting}

Before we try execute our algorithm, let's try to understand it a little bit. There are three steps, and they exhibit most of our programming friends!
