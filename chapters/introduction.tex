...
\begin{figure}
  ...
  \caption{\label{fig:intro-expression-fundemental-diagram} The syntax for arithmetic makes it easy to compose many arithmetic transformers together in short expressions.}
\end{figure}
...
\section{Variables}
\textbf{TODO: identifiers, box diagram of data types, expressions, evaluation, initialization, assignment}
