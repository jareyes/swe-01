...
\begin{table*}
  ...
  \begin{tabular}{l c l c c c c}
    ...
    Step 2 (Evaluate) & \texttt{2} & \texttt{1.5} & (1.5 + 2/1.5)/2 & 1.41666 & ---& 0.1666\\
...
\textbf{TODO: Expressions and evaluation}.

\section{Variables}
\textbf{TODO: identifiers, box diagram of data types, expressions, evaluation, assignment}
