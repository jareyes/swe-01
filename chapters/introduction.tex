...
Before we dive into the nitty gritty of writing programs, we should start with the singular idea at the core of it all. There is one diagram that sums up almost all of computer science and software engineering. It's so ubiquitous that it's called \textbf{Fundamental Diagram of Programming}.\sidenote{Okay, maybe only \emph{I} call it that. But everyone should. It's that important}
