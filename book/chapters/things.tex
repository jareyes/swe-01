...
%
% This is the same as a question and answer. Request and reponse. Order and
...
%
% \section{Programming}
% Programming can feel complicated. And a lot of times it is. But underneath all
...
% \end{enumerate}
%
% If you can master those four things, you will have mastered software
engineering.
%
% \section{Storing information}
% Storing information is at the heart of software. Data is king. You see it
...
%
% You have come across many different data storage mechanisms. Data can be saved
...
%
% The power of data does not come solely from storing it. Buried treasure isn't
valuable until you dig it up and use it. So, too, with data. To be useful, we
need to be able to retrieve and employ the data we have stored to complete a
...
%
% The actual mechanism you use to store and retrieve your data isn't especially
...
%
% How you structure an email is different from how you structure a novel. Good
...
%
% Style is a holy war. Nothing is perfect. Always trade-offs. Often it's a
...
Examples. Fetching a web page: request/response. Mathematical functions.
...
\section{Refactoring} Have a refactoring example where functions write to
